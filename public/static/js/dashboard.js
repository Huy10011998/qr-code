(function ($) {
  ...
  $(".btn-menu").on("click", function () {
    ...
    if (collapse.length > 0) {
      ...
      sidebarItem.each(function (_, item) {
        ...
        if (window.location.pathname !== `http://localhost:8888/dashboard` && window.location.pathname !== "http://localhost:8888/dashboard/") {
  ...
  function createQrCode() {
    ...
    $.ajax({
      url: 'http://localhost:8888/api/auth/createQrCode',
      method: "POST",
      contentType: 'application/json',
      data: JSON.stringify({
  ...
  function genQrCode(id) {
    const baseURL = `http://localhost:8888/profile/${id}`;
  ...
  function deleteQrCode(userId) {
    ...
    $.ajax({
      url: 'http://localhost:8888/api/auth/deleteQrCode',
      type: 'DELETE',
      dataType: 'json',
      headers: {
        "token": token,
  ...
  function getQrCode(userId_) {
    ...
    $.ajax({
      url: 'http://localhost:8888/api/auth/getQrCode',
      method: "POST",
      contentType: 'application/json',
      data: JSON.stringify({
        userId: userId_,
  ...
  function updateQrCode(userId_) {
    ...
    $.ajax({
      url: `http://localhost:8888/api/auth/updateQrCode/${userId_}`,
      method: "PUT",
      contentType: 'application/json',
      data: JSON.stringify({
  ...
  function listQrCode(page = 1, limit = 10) {
    ...
    $.ajax({
      "url": 'http://localhost:8888/api/auth/listQrCode',
      "method": "POST",
      "headers": {
        "token": token,
        "Content-Type": "application/json",
